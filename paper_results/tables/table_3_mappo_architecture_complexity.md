| component | measure | value | unit | source | value_status |
|---|---|---|---|---|---|
...
| checkpoint | mappo.pth file size | 5193039 | bytes | mappo.pth | observed file size |
| checkpoint | mappo_best.pth file size | 5204954 | bytes | mappo_best.pth | observed file size |
